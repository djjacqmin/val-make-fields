...
MLC_field_size = [ 2 5 7 10 12.4 15 17.4 20 ];
Jaw_field_size = [ 2 5 7 10 12.4 15 17.4 20 ];
depths = [ 10 ];
SSD = 93;
MU = 200;
...
for f=1:length(MLC_field_size)
    ...
    if (mlcFS > 15)
        ...
        bank_A = (mlcFS/2)*ones(60,1);
        bank_B = -(mlcFS/2-.5)*ones(60,1);
    end
    ...
    fprintf(fid,'  Name = \"Square %.1fx%.1f";\n',mlcFS,mlcFS);
    fprintf(fid,'  FieldID = "%.0f";\n',f);
